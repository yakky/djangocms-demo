...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('news_news', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'News.title'
        db.alter_column('news_news', 'title', self.gf('django.db.models.fields.TextField')(max_length=255))
