...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'News.abstract'
        db.alter_column('news_news', 'abstract', self.gf('djangocms_text_ckeditor.fields.HTMLField')())

    def backwards(self, orm):

        # Changing field 'News.abstract'
        db.alter_column('news_news', 'abstract', self.gf('django.db.models.fields.TextField')())
