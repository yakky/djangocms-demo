...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SortableModel.others'
        db.add_column(u'news_sortablemodel', 'others',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SortableModel.others'
        db.delete_column(u'news_sortablemodel', 'others_id')
    ...
    models = {
        ...
        u'news.sortablemodel': {
            'Meta': {'ordering': "('position',)", 'object_name': 'SortableModel'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'others': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
