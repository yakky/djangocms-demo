...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SortableModel.abstract'
        db.add_column(u'news_sortablemodel', 'abstract',
                      self.gf('djangocms_text_ckeditor.fields.HTMLField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SortableModel.abstract'
        db.delete_column(u'news_sortablemodel', 'abstract')
